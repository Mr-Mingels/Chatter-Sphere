...
const Main = ({
  setExtractedUserInfo,
  setExtractedChatsListInfo,
  getChatListInfoFunction,
  ...
  return (
    <div className="mainWrapper">
        ...
        >
          {modalOpen && (
            <Modal
              ...
              setInformModalTxt={setInformModalTxt}
              setInformModalOpen={setInformModalOpen}
              setInformModalColor={setInformModalColor}
              getChatListInfo={getChatListInfo}
            />
          )}
          <div
            className={`sideBarWrapper ${sideBarOpen ? "open" : ""}`}
            ...
            <div className="sideBarContent">
              <div className="sideBarUserInfoWrapper">
                {userInfo.profilePicture ? (
                  ...
                  <div className="sideBarDefaultProfileImg">
                ...
                <ul className="optionWrapper">
                  ...
                  <li className="option" onClick={() => openModal("friends")}>
                    <div className="optionIconWrapper">
                      ...
                      >
                        <path
                          d="M224 256A128 128 0 1 0 224 0a128 128 0 1 0 0 256zm-45.7 48C79.8 304 0 383.8 0 482.3C0 498.7 
                                  13.3 512 29.7 512H418.3c16.4 0 29.7-13.3 29.7-29.7C448 383.8 368.2 304 269.7 304H178.3z"
                        />
                      </svg>
                    </div>
                    Friends
                  ...
                  <li
                    className="option"
                    onClick={() => openModal("add a profile picture")}
                  >
                    <div className="optionIconWrapper">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                  ...
                  <li className="option" onClick={() => toggleNightMode()}>
                    <div className="optionIconWrapper">
                      {nightMode ? (
                        ...
                        >
                          <path
                            d="M361.5 1.2c5 2.1 8.6 6.6 9.6 11.9L391 121l107.9 19.8c5.3 1 9.8 4.6 11.9 9.6s1.5 10.7-1.6 
                                  ...
                                  15.2-1.6zM160 256a96 96 0 1 1 192 0 96 96 0 1 1 -192 0zm224 0a128 128 0 1 0 -256 0 128 128 0 1 0 256 0z"
                          />
                        </svg>
                      ) : (
                        <svg
                        ...
                        >
                          <path
                            d="M223.5 32C100 32 0 132.3 0 256S100 480 223.5 480c60.6 0 115.5-24.2 155.8-63.4c5-4.9 
                                  6.3-12.5 3.1-18.7s-10.1-9.7-17-8.5c-9.8 1.7-19.8 2.6-30.1 2.6c-96.9 0-175.5-78.8-175.5-176c0-65.8 
                                  36-123.1 89.3-153.3c6.1-3.5 9.2-10.5 7.7-17.3s-7.3-11.9-14.3-12.5c-6.3-.5-12.6-.8-19-.8z"
                          />
                        </svg>
                      )}
                    </div>
                  ...
                  <li className="option" onClick={() => openModal("userID")}>
                    <div className="optionIconWrapper">
                      ...
                      >
                        <path
                          d="M256 48V64c0 17.7-14.3 32-32 32H160c-17.7 0-32-14.3-32-32V48H64c-8.8 0-16 7.2-16 
              ...
              <div className="sideBarFooterWrapper">
                ...
                {logOutLoader ? (
                  <button className="sideBarLogOutBtn logOutLoader">
                    <span className="modalLoader"></span>
                  </button>
                ) : (
                  <button className="sideBarLogOutBtn" onClick={() => logOut()}>
                    Log Out
                  </button>
                )}
              </div>
        ...
        <div className="chatsContent">
          <nav className="chatsNavBar">
            ...
            <input
              ...
              onChange={handleChatsListInfoSearch}
            />
          </nav>
              ...
              {searchedChatsListInfo.map((chat, index) => (
                <Link
                  className={`chatWrapper ${
                    location.pathname.split("/")[2] === chat._id ? "inChat" : ""
                  }`}
                  key={index}
                  to={`/chat/${chat._id}`}
                  onMouseDown={(e) => e.preventDefault()}
                    ...
                    <>
                      {chat.friend.profilePicture ? (
                        <img
                          ...
                          className="chatImg"
                          alt="the friends chat pic"
                        />
                      ) : (
                        <div className="chatDefaultImgWrapper">
                          <h3 className="chatDefaultImg">
                      ...
                      <span className="chatName">
                        {chat.friend.username.charAt(0) +
                          chat.friend.username.slice(1).toLowerCase()}
                      </span>
                    </>
                  )}
                  {chat.isGroupChat && (
                    <>
                      ...
                      <span className="chatName">
                        {chat.chatName.charAt(0) +
                          chat.chatName.slice(1).toLowerCase()}
                      </span>
                    </>
                  )}
                </Link>
      ...
      <section
        className={`chatMessagesSectionWrapper ${
