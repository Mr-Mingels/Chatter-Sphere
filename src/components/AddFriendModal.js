      ...
      <div className="addFriendModalMainContentWrapper">
        <div className="addFriendModalMainContent">
          ...
          <input
            name="friendRequest"
            maxLength="50"
            className={`addFriendModalInput ${
              redAddFriendPlaceHolder ? "field" : ""
            }`}
            value={friendUserId.value}
            onChange={(e) =>
              setFriendUserId({ ...friendUserId, value: e.target.value })
            }
        ...
        <div className="addFriendModalFooterWrapper">
          <button
            className="addFriendModalBtn closeBtn"
            onClick={() => closeModal()}
          >
            Close
          </button>
          {loader ? (
            <button className="addFriendModalBtn addFriendLoader">
              <span className="modalLoader"></span>
            </button>
          ) : (
            <button
              className="addFriendModalBtn"
