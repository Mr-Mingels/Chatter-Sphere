...
const AddPictureModal = ({
  ...
  handleProfileImgFileChange,
  closeModal,
  addProfileImg,
  closeAddPictureModal,
  selectedGroupImgFile,
  addGroupImg,
  handleGroupImgFileChange,
  groupImgModalOption,
  loader,
  modalLoader,
}) => {
  ...
  return (
    <div className="profilePicModalMainContentWrapper">
      <div className="profilePicModalHeaderWrapper">
        <h3 className="profilePicModalHeader">
          {groupImgModalOption
            ? "Add a Group Picture"
      ...
      <div className="profilePicModalMainContent">
        {selectedImgFile ? (
          <img
            ...
            className="profilePicModalImg"
            onClick={() => document.getElementById("hiddenFileInput").click()}
            alt="modal profile pic"
          />
        ) : (
          <div
            className="defaultProfilePicModalImg"
            onClick={() => document.getElementById("hiddenFileInput").click()}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="profileDefaultPicModalImg"
              viewBox="0 0 512 512"
            >
              <path
        ...
        <p className="profilePicTxt">
          Click the above icon to add an image
          {groupImgModalOption ? " to your group" : ""}
        </p>
        <input
          id="hiddenFileInput"
          type="file"
      ...
      <div className="profilePicModalFooterWrapper">
        ...
        {loader || modalLoader ? (
          <button className="profilePicModalBtn picLoader">
          ...
          <button
            className="profilePicModalBtn"
            onClick={
              groupImgModalOption ? () => addGroupImg() : () => addProfileImg()
            }
          >
            Add
          </button>
