...
const Modal = ({ modalConfig, userInfo, setModalOpen, getUserInfo, setInformModalOpen, setInformModalTxt, setInformModalColor, 
    ...
    const sendFriendRequest = async () => {
        ...
        try {
            const response = await axios.put('https://chatter-sphere-app-api.onrender.com/send-friend-request', friendRequestObject, { withCredentials: true });
    ...
    const getSentRequestUserInfo = async () => {
        try {   
            const response = await axios.get('https://chatter-sphere-app-api.onrender.com/sent-friend-requests', { withCredentials: true });
    ...
    const getRecievedRequestUserInfo = async () => {
        try {   
            const response = await axios.get('https://chatter-sphere-app-api.onrender.com/received-friend-requests', { withCredentials: true });
            if (response.status === 200 && response.data) {
    ...
    const acceptFriendRequest = async (requestedFriendId, requestedFriendUserName) => {
        try {
            const response = await axios.put('https://chatter-sphere-app-api.onrender.com/accept-friend-request', { requestedFriendId }, { withCredentials: true })
            if (response.status === 200) {
    ...
    const declineFriendRequest = async (requestedFriendId, requestedFriendUserName) => {
        try {
            const response = await axios.put('https://chatter-sphere-app-api.onrender.com/decline-friend-request', { requestedFriendId }, { withCredentials: true })
            if (response.status === 200) {
    ...
    const unsendFriendRequest = async (requestedFriendId) => {
        try {
            const response = await axios.put('https://chatter-sphere-app-api.onrender.com/unsend-friend-request', { requestedFriendId }, { withCredentials: true })
            if (response.status === 200) {
    ...
    const addProfileImg = async () => {
        ...
        try {
            const response = await axios.put(`https://chatter-sphere-app-api.onrender.com/add-profile-picture`, formData, { 
    ...
    const createGroup = async () => {
        ...
        try {
            const response = await axios.post(`https://chatter-sphere-app-api.onrender.com/create-group`, formData, { 
                withCredentials: true,
                headers: {
                    'Content-Type': 'multipart/form-data',
                },
