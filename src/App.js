      ...
      <BrowserRouter>
        ...
        >
          <Routes>
            <Route
              path="/sign-up"
              element={<Authenticate windowWidth={windowWidth} />}
            />
            <Route
              path="/log-in"
              element={<Authenticate windowWidth={windowWidth} />}
            ...
            <Route
              ...
              element={
                <Main
                  ...
                  setExtractedChatsListInfo={setExtractedChatsListInfo}
                  getChatListInfoFunction={getChatListInfoFunction}
              ...
              <Route
                ...
                element={
                  <Messages
                    ...
                    extractedChatsListInfo={extractedChatsListInfo}
