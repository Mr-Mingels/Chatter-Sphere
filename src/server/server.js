...
const io = require('socket.io')(http, {
    cors: {
      origin: ["http://localhost:3000", "https://chatter-sphere.onrender.com/", "http://localhost:5000"],
      methods: ["GET", "POST"],
      credentials: true
    }
});
...
app.use(cors({ origin: ["http://localhost:3000", "https://chatter-sphere.onrender.com/", "http://localhost:5000"], credentials: true }));
